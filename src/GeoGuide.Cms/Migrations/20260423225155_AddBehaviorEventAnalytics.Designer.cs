...
namespace GeoGuide.Cms.Migrations
{
    ...
    [Migration("20260423225155_AddBehaviorEventAnalytics")]
    partial class AddBehaviorEventAnalytics
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GeoGuide.Cms.Models.DeviceSessionJoin", b =>
                {
                    ...
                    b.HasIndex("SessionToken", "DeviceId")
                        .IsUnique();

                    b.ToTable("device_session_joins", (string)null);
                });
            ...
            modelBuilder.Entity("GeoGuide.Cms.Models.PoiAudio", b =>
                {
                    ...
                    b.ToTable("poi_audios", (string)null);
